  ...
  <main class="h-screen w-screen flex justify-center items-center bg-background">
    <form @submit.prevent="handleSubmit" class="w-full flex flex-col items-center">
      ...
      <div class="w-1/3 h-full mb-4 px-2">
        <label class="text-gray-100 font-bold block mb-2 text-sm" for="pretext-input">Posta Elektronikoa</label>
      ...
      <div class="w-1/3 mb-4 px-2">
        <label class="text-gray-100 font-bold block mb-2 text-sm" for="pretext-input">Pasahitza</label>
        <div class="flex w-full">
          <div
      ...
      >
        <p class="text-sm">¿Pasahitza ahaztu duzu?</p>
      </a>
    </form>
    <div
