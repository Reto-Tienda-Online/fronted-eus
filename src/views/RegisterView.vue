        ...
        <section class="bg-gray-50 dark:bg-gray-900">
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <router-link to="/" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img class="w-[100px] h-[50px] mr-2" src="../img/icono-white.svg" alt="logo">
                </router-link>
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form @submit.prevent="handleSignup" class="space-y-4 md:space-y-6" action="#">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="firstName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Izena</label>
                                ...
                                <div>
                                    <label for="lastName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Abizena</label>
                            ...
                            <div>
                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Posta Elektronikoa</label>
                            ...
                            <div>
                                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pasahitza</label>
                            ...
                            <div>
                                <label for="confirmPassword" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pasahitza Egiaztatu</label>
...
const handleSignup = async () => {
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            successMessage.value = 'Erregistratu zara !';
        ...
        errorMessage.value = 'Erabiltzailea existitzen da, erabili beste korreo bat';
